...
```{r}
food_truck_df <- data.frame(
  Name = food_trucks$Name,
  Address = food_trucks$Address,
  Rating = food_trucks$Rating,
  Website = food_trucks$Website,
  Hour = food_trucks$Hour,
  Cuisine = food_trucks$Cuisine
)
```
